...
<form className="w-11/12 max-w-[350px] mt-32">
    ...
    <input type="text" id="name" className="shadow-sm bg-[white] text-black  text-sm rounded-lg w-full p-2.5" placeholder="Enter your name" required />
  </div>
  <div className="mb-5 w-full ">
  ...
  <div className="mb-5 w-full ">
    ...
    <input type="text" id="photo" className="shadow-sm bg-[white] text-black  text-sm rounded-lg w-full p-2.5" placeholder="Enter your photo URL" required />
  </div>
  <div className="mb-5">
